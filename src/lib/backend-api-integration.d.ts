...
declare module './backend-api-integration' {
  ...
  export type TradeMarketEventHandler = (marketId: string, trade: Trade) => void | Promise<void>;
  export type TradeWalletEventHandler = (walletAddress: string, trade: Trade) => void | Promise<void>;
  export type LeaderTradeEventHandler = (leader: LeaderWallet, trade: Trade) => void | Promise<void>;
  export type MarketUpdateEventHandler = (marketId: string, market: Market) => void | Promise<void>;
  export type MarketStatsEventHandler = (marketId: string, stats: MarketStats) => void | Promise<void>;
  export type LeaderDetectedEventHandler = (wallet: LeaderWallet) => void | Promise<void>;
  ...
  export class BackendAPIIntegration extends EventEmitter {
    ...
    // Market stats
    fetchMarketStats(marketId: string, useCache?: boolean): Promise<MarketStats>;
